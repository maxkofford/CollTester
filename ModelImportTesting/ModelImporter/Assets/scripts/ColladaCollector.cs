...
public class ColladaCollector : MonoBehaviour
{
    ...
    private string url = "http://orbcreation.com/SimpleCollada/mushroom.dae";
    ...
    void Update()
    {
       ...
       // PositionCameraToShowTargetObject();
        ...
        {
           // Vector3 curscale = targetObject.transform.localScale;
            targetObject.transform.localScale += new Vector3( 1, 1,  1);
        }
        if (Input.GetKeyDown(KeyCode.DownArrow))
        {
           // Vector3 curscale = targetObject.transform.localScale;
           // targetObject.transform.localScale = new Vector3(curscale.x - 1, curscale.y - 1, curscale.z - 1);
            targetObject.transform.localScale -= new Vector3(1, 1, 1);
        }
